...
namespace App\Http\Controllers\Purchasing\Reports\SupplierStatement;
...
use App\Exports\Purchasing\Reports\SupplierStatementExport;
   ...
   public function index(Request $request)
{
    ...
    return Inertia::render(
        'Purchasing/Reports/SupplierStatement',
        [
            'report' =>
                $report,
    ...
    */
    ...
    public function pdf(Request $request)
    {
        ...
        return Pdf::loadView(
            'pdf.purchasing.reports.supplier-statement',
            [
                'report' =>
                    $report,
