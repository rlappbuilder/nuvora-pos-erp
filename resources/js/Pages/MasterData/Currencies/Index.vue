...
const pageTitle = computed(() => 'Cuurency')
...
const isAllSelected = computed(() => {
    ...
    return (
        ...
        selectedRows.value.length === props.currencies.data.length
    )
...
function toggleSelectAll(event)
{
    if (event.target.checked) {
        ...
        selectedRows.value = props.currencies.data.map(
...
const bulkDeleteMessage = computed(() => {
    ...
    return `Are you sure you want to delete ${total} selected Currency(s)?`
...
const bulkActivate = () => {
    ...
    router.post(
        route('currencies.bulk-activate'),
        {
            ids: selectedRows.value,
        },
        {
...
const bulkActivateMessage = computed(() => {
    ...
    return `Are you sure you want to activate ${total} selected Currency(s)?`

})
const bulkDeactivate = () => {

    router.post(
        route('currencies.bulk-deactivate'),
        {
            ids: selectedRows.value,
        },
        {
...
const bulkDeactivateMessage = computed(() => {
    ...
    return `Are you sure you want to deactivate ${total} selected Currency(s)?`
...
{
    console.log(route('currencies.destroy',deleteItem.value.id))
    if (!deleteItem.value) {
    ...
    <AppLayout>
        ...
        >
            ...
            <PageHeader
                ...
                subtitle="Manage product Currencies."
                        ...
                        <TableEmpty
                            ...
                            >
                                <template #action>
                                    ...
                                    <BaseButton
                                        @click="router.visit(route('currencies.create'))"
                                    >
                                        Create Currency
                                    </BaseButton>
