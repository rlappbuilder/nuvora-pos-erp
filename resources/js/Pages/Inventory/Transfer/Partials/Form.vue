...
<template>
    ...
    <form @submit.prevent="emit('submit')">
        ...
        <!-- ========================================================= -->
        <!-- Invnetory Stock Transfer Information -->
        <!-- ========================================================= -->

        <FormSection
            icon="📦"
            title="Stock Transfer Information"
            description="Basic information about this Inventory Stock Transfer."
            :columns="2"
        >
        ...
        <FormSection
            icon="📋"
            title="Stock Details"
            description="Add products and define Stock Transfers and costs."
            :columns="1"
        >
