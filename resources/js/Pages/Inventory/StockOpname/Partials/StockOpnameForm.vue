...
const loadWarehouseStocks = async (warehouseId) => {
    ...
    try {
        ...
        const response = await fetch(
            route(
                'stock-opnames.warehouse-stocks',
                warehouseId
            )
        )
...
<template>
    ...
    <form @submit.prevent="emit('submit')">
        ...
        <FormSection
            ...
            description="Basic information about this Stock Opname transaction."
            :columns="2"
        >
        ...
        <FormSection
            icon="📋"
            title="Stock Details"
            description="Add products and record actual stock quantities."
            :columns="1"
        >
<div class="w-full overflow-x-auto">
    ...
    <div class="min-w-[1100px] space-y-4">
        ...
        <FormSection
            icon="📝"
            title="Description"
            description="Additional information about this Stock Opname transaction."
            :columns="1"
        >
