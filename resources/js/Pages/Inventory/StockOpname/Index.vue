...
import StockOpnameForm    from './Partials/StockOpnameForm.vue'
import StockOpnameViewModal    from './Partials/StockOpnameViewModal.vue'
...
function editOpname(item)
{
    if (item.status === 'Posted') {

        error(
            'Stock Opname that has been posted cannot be edited.'
        )
    ...
    router.post(
        ...
        {},
        {
            ...
            onError: () => {
                ...
                error(
                    'Failed to duplicate stock Opname.'
                )
...
const bulkDeleteMessage = computed(() => {
    ...
    return `Are you sure you want to delete ${total} selected Stock Opname document(s)?`
...
{
    router.delete(
        route('stock-opnames.bulk-delete'),
        {
            data: {
...
function openPost(opname)
{
    postItem.value = opname
...
function openReject(opname)
{
    rejectItem.value = opname
...
async function openView(item)
{
    ...
    try {
        ...
        error(
            'Failed to load Stock Opname detail.'
        )
        ...
        >
            ...
            <div class="mt-6">
                    ...
                    <DataTableBody>
                        ...
                        >
                            ...
                            <DataTableCell align="right">
                                ...
                                {{ currency(item.difference_cost ?? 0) }}
                ...
                <TableEmpty
                    v-else
                    icon="📦"
                    title="No Stock Opname Found"
                    description="There are no Stock Opname transactions available."
                >
            ...
            <PageHeader
                ...
                :subtitle="
                    formMode === 'create'
                        ...
                        : 'Update Stock Opname transaction.'
                "
            />
                    ...
                    >
                        ...
                        >
                           Please make sure the system quantity,
                            actual quantity, and Stock Opname cost
