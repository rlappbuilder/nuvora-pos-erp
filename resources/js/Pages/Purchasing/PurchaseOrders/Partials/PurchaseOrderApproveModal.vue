...
const subtotal = computed(() => {
    ...
    return Number(
        props.purchaseOrder?.subtotal ?? 0
    )
...
const discountAmount = computed(() => {
    ...
    return Number(
        props.purchaseOrder?.discount_amount ?? 0
    )
...
const taxAmount = computed(() => {
    ...
    return Number(
        props.purchaseOrder?.tax_amount ?? 0
    )
...
const grandTotal = computed(() => {
    ...
    return Number(
        props.purchaseOrder?.grand_total ?? 0
    )
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                discount, tax, required date,
                                and other information carefully.
                                Approving this purchase order will
                                move it to the next purchasing
                                process.
                            </p>
