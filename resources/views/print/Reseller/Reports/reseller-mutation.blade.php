...
<div class="toolbar">
    ...
    <div class="toolbar-actions">
        ...
        <button
            type="button"
            class="back"
            onclick="window.location.href='{{ route('reseller-mutations.index', $filters) }}'"
        >
            ← Back
        </button>
...
<div class="paper">
    ...
    <div class="basis">
        ...
        Balance Qty is calculated from cumulative
        In minus Out.

        Balance Value is calculated from cumulative
        Debit minus Credit.
